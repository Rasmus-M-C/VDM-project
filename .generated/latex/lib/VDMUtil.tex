...
seq_of_char2val(s) ==
(*@\vdmnotcovered{le}@*)t mk_(b, v) = (*@\vdmnotcovered{seq\_of\_char2val}@*)_((*@\vdmnotcovered{}@*)s) in
    (*@\vdmnotcovered{i}@*)f (*@\vdmnotcovered{is}@*)_((*@\vdmnotcovered{}@*)v, @p) then (*@\vdmnotcovered{mk}@*)_((*@\vdmnotcovered{}@*)b, (*@\vdmnotcovered{}@*)v) else (*@\vdmnotcovered{mk}@*)_((*@\vdmnotcovered{fals}@*)e, (*@\vdmnotcovered{ni}@*)l)
post (*@\vdmnotcovered{le}@*)t mk_(b,t) = (*@\vdmnotcovered{RESUL}@*)T in (*@\vdmnotcovered{no}@*)t (*@\vdmnotcovered{}@*)b (*@\vdmnotcovered{=}@*)> (*@\vdmnotcovered{}@*)t (*@\vdmnotcovered{}@*)= (*@\vdmnotcovered{ni}@*)l;
